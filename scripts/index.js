...
const handleSubmit = (event) => {
    ...
    if (input.url === '' || input.description === '' || input.type === '') { return alert('Please fill all the fields'); };
...
const deleteTask = (e) => {
    ...
    updateLocalStorage();
    if (type === 'BUTTON') return e.target.parentNode.parentNode.parentNode.remove();
